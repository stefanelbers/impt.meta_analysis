...
ui <- fluidPage(
  ...
  sidebarLayout(
    ...
    mainPanel(
      ...
      # Output: Histogram ----
      formattableOutput(outputId = "time_series")
...
#create input value for Shiny function
#input <- "pintens"
  
#input <- reactive(input$outcome)  
