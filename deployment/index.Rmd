...
#For Ubuntu servers
#summarytools requires: magick
#sudo apt-get install libmagick++-dev
#revtools requires:gsl
...
This online repository contains all study data of a systematic review and meta analysis on the development over time of interdisciplinary multimodal pain treatment (IMPT) programs. <a href="https://www.crd.york.ac.uk/prospero/display_record.php?RecordID=76093" target="_blank">click here</a> for the study protocol. <br />

The manuscript of the base systematic review is currently under review. More details regarding publication will be presented on this page <br />
...
<a href="https://github.com/stefanelbers/impt.meta_analysis/blob/7d1d41b14708fb7db1daa9b4b74f5fe5abdf1e64/deployment/forms/second_round_screening_form.pdf" target="_blank">click here</a> for the second round screening form. <br />
<a href="https://github.com/stefanelbers/impt.meta_analysis/blob/6e88756399c84ee7f9421a1eb5c3574959a58b3c/deployment/forms/S2.data_extraction_form.pdf" target="_blank">click here</a> for the data extraction form. <br />
<a href="https://github.com/stefanelbers/impt.meta_analysis/blob/6e88756399c84ee7f9421a1eb5c3574959a58b3c/deployment/forms/rob_assessment_form.pdf" target="_blank">click here</a> for the risk of bias form. <br />
<a href="https://github.com/stefanelbers/impt.meta_analysis/blob/master/deployment/forms/complete_search_flow_deduplicated.txt" target="_blank">click here</a> for the deduplicated set of first round screening study records. <br />
...
### flow chart
```{r}
prisma(31933, 129, 17988, 17988, 17608, 380, 315, 65, 57)
```
...
reactable(t_fulltext,
          ...
          columns = list(
            ...
            decision = colDef(maxWidth = 70, cell = function(value) {
              ...
              if (value == 0) {color <- '#e5383b'} else {color <- '#73a942'}
              list(background = color)})
          ),
          bordered = FALSE,
          highlight = FALSE,
