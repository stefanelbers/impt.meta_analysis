...
dat_poms$s_tension <- (dat_poms$tension / 24) *100
dat_poms$s_anger <- (dat_poms$anger /24) *100
dat_poms$s_fatigue <- (dat_poms$fatigue / 20) * 100
dat_poms$s_depression <- (dat_poms$depression / 28) * 100
dat_poms$s_esteem <- (dat_poms$esteem / 24) * 100
dat_poms$s_vigour <- (dat_poms$vigour / 20) *100
dat_poms$s_confusion <- (dat_poms$confusion / 20) * 100

s_poms <- c("s_tension", "s_anger", "s_fatigue", "s_depression", "s_esteem", "s_vigour", "s_confusion")
summary(dat_poms[,s_poms])
