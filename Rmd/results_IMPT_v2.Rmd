...
knitr::opts_knit$set(root.dir = "/home/stefan_elbers/impt.meta_analysis")
```
...
t2 <- t2 %>% 
  dplyr::rename(
    "other_hcp" = "other_healthcare_providers",
    "mod_subinfo" = "mode_of_delivery_subinfo",
    "fu provided" = "followup_sessions_provided",
    "fu_desc" = "followup_sessions_description")


procedure_cols <- c("ed", "ex", "ga", "bt", "re", "pm", "ph", "ba", "wo", "te", "other_procedures")
hcp_cols <- c("phy", "psy", "pt", "ot", "nur", "swo", "other_hcp")
...
reactable(t2,
          ...
          style = list(fontFamily = "Arial Narrow", fontSize = "14px"),
          columnGroups = list(
            colGroup(name = "tm", columns = procedure_cols),
            colGroup(name = "hcp", columns = hcp_cols)
            ),
          defaultColDef = colDef(
            align = "left",
            minWidth = 70
          ...
          columns = list(
            ...
            other_hcp = colDef(minWidth = 110),
            fu_desc = colDef(minWidth = 150),
            cohort_id = colDef(maxWidth = 30, name = "ID"),
